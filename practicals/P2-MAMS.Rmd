...
This markdown document contains the exercises of the second practical session of the course *`A practical introduction to simulating complex trial designs'* (CEN2026).
